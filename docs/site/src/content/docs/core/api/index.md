...
| `withZoom`, `withAnnotation`, `withDataLabels`, `withGradient`, `withTimestack`, `withHierarchical`, `withImageLabel` | [Plugins](/core/api/plugins) | Implemented |
| Plugin option types (`ZoomPluginOptions`, `AnnotationPluginOptions`, `DataLabelsPluginOptions`, `ImageLabelPluginOptions`) | [Plugins](/core/api/plugins) | Implemented |
...
- **[Plugins](/core/api/plugins)** — the 7 official plugin/scale helpers
