...
- `<Chart>` single-file component for Vue 3 — one generic component
  covering all 15 chart kinds (8 built-in + 7 ecosystem extensions), all 10
...
- 49 component tests, 100% coverage (statements/branches/functions/lines).
- 84/84 Playwright e2e tests passing across Chromium, Firefox, and WebKit —
  all 15 chart kinds, all 10 plugins, and resize behavior confirmed rendering
